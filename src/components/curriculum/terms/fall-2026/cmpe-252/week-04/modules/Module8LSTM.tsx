...
export const Module8LSTM: React.FC = () => {
  return (
    <div className="space-y-6 animate-fade-in text-slate-200">
      <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 space-y-3 shadow-sm">
        <h3 className="text-base font-bold text-slate-100 flex items-center gap-2">
          ...
          <span>Module 8: Long Short-Term Memory (LSTM)</span>
        </h3>
        <p className="text-xs text-slate-400 leading-relaxed">
          Cell state highways, forget gates, input gates, output gates, and additive error propagation.
        </p>
