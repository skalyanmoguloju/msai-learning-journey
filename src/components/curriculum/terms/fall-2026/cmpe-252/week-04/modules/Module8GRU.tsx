...
export const Module8GRU: React.FC = () => {
  return (
    <div className="space-y-6 animate-fade-in text-slate-200">
      <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 space-y-3 shadow-sm">
        <h3 className="text-base font-bold text-slate-100 flex items-center gap-2">
          ...
          <span>Module 8: Gated Recurrent Unit (GRU)</span>
        </h3>
        <p className="text-xs text-slate-400 leading-relaxed">
          Gated mechanisms, update gates, reset gates, candidate activations, and parameter-efficient long-term sequence learning.
        </p>
