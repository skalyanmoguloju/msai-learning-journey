...
export const Module9LSTM: React.FC = () => {
  return (
    <div className="space-y-6 animate-fade-in text-slate-200">
      <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 space-y-3 shadow-sm">
        <h3 className="text-base font-bold text-slate-100 flex items-center gap-2">
          ...
          <span>Module 9: Long Short-Term Memory (LSTM)</span>
        </h3>
        <p className="text-xs text-slate-400 leading-relaxed">
          The cell state highway, forget gate, input gate, output gate, and additive gradient protection against vanishing signals.
        </p>
