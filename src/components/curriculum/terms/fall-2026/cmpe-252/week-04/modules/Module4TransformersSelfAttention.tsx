...
export const Module4TransformersSelfAttention: React.FC = () => {
  return (
    <div className="space-y-6 animate-fade-in text-slate-200">
      <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 space-y-3 shadow-sm">
        <h3 className="text-base font-bold text-slate-100 flex items-center gap-2">
          <Zap className="w-5 h-5 text-indigo-400" />
          <span>Module 4: Transformers and self-attention</span>
        </h3>
        <p className="text-xs text-slate-400 leading-relaxed">
          Scaled dot-product attention, query-key-value projections, multi-head mechanisms, and sequence-to-sequence representations.
        </p>
