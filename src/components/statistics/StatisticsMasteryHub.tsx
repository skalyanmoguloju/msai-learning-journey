...
export const StatisticsMasteryHub: React.FC = () => {
  const [activeModuleId, setActiveModuleId] = useState<number>(7);
  ...
  const [activeTab, setActiveTab] = useState<'study' | 'quiz' | 'flashcards'>('study');
  ...
  // Quiz computations
  const currentQuizMod = STAT_QUIZ_MODULES[quizModuleKey] || STAT_QUIZ_MODULES.m1;
    ...
    <div className="space-y-6 animate-fade-in text-slate-100">
      ...
      <div className="rounded-2xl p-4 sm:p-6 bg-gradient-to-r from-slate-900 via-slate-900 to-indigo-950/40 border border-slate-800 shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-3.5">
          <div className="bg-gradient-to-tr from-blue-600 to-cyan-500 p-3 rounded-2xl shadow-lg shadow-blue-500/20 text-white shrink-0">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-400">Degree Foundation</span>
            </div>
            <h2 className="text-xl sm:text-2xl font-extrabold text-white tracking-tight mt-0.5">
              Probabilistic Machine Learning &amp; Naive Bayes Masterclass
            </h2>
            <p className="text-xs text-slate-400 mt-1">
              Modules 1–10 Interactive Laboratory, Derivations, Formula Sheets &amp; Simulators
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5 shrink-0 self-end md:self-auto flex-wrap">
          ...
          >
            Math Notation: <strong className={globalMathEnabled ? 'text-cyan-400' : 'text-slate-400'}>{globalMathEnabled ? 'On' : 'Off'}</strong>
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 items-start">
        ...
        <div className="lg:hidden w-full space-y-2">
          {/* Practice Quizzes, Flashcards & Solutions Guide mobile switchers */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            ...
            <button
              ...
              className={`py-2 px-3 rounded-xl text-xs font-bold transition flex items-center justify-center gap-1.5 ${
                showFlashcardsModal || activeTab === 'flashcards'
            ...
            <button
              onClick={() => {
                setActiveTab('quiz');
                setShowSolutionsGuide(false);
                const validKey = (activeModuleId >= 1 && activeModuleId <= 7) ? `m${activeModuleId}` : 'm1';
                setQuizModuleKey(validKey);
              }}
              className={`py-2 px-3 rounded-xl text-xs font-bold transition flex items-center justify-center gap-1.5 ${
        ...
        <aside className="hidden lg:block w-72 flex-shrink-0 space-y-3 sticky top-4">
          <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-sm">
            <div className="flex items-center justify-between px-1 mb-3">
              ...
              <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-cyan-950 text-cyan-300 border border-cyan-800">
                {completedModules.length}/10 Done
              </span>
            </div>
          ...
          {/* Interactive Flashcards, Practice Quizzes & Tools Card */}
          <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-sm space-y-2">
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <span>VIP Formula Cards</span>
              </div>
              <span className="text-[10px] font-bold px-1.5 py-0.5 rounded bg-indigo-500/20 text-indigo-300 font-mono">
                34 Cards
              </span>
            </button>
            <button
          ...
          <div className="bg-gradient-to-br from-slate-900 via-slate-900/80 to-indigo-950/40 border border-slate-800 rounded-2xl p-4 shadow-sm space-y-2.5">
            ...
            <div className="flex items-center justify-between text-[11px] text-slate-400 pt-0.5">
              <span>Module {activeModule.id} of 10</span>
        ...
        {activeModule.interactiveType === 'mcmc-vi' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <div className="h-64 bg-slate-950 p-3 rounded-2xl border border-slate-800 flex items-center justify-center">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-r from-indigo-950/60 via-slate-900 to-cyan-950/60 border border-indigo-800/40 rounded-2xl p-5 sm:p-6 shadow-lg flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="space-y-1 text-center sm:text-left">
                    <div className="flex items-center justify-center sm:justify-start gap-2">
                      <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-cyan-500/20 text-cyan-300 border border-cyan-500/30">
                        Ready to test your mastery?
                      </span>
                      <span className="text-xs text-slate-400">35 Rigorous Problems across Modules 1–7</span>
                    </div>
                    <h4 className="text-base font-bold text-white">
                      Practice Module {Math.min(activeModule.id, 7)}: {STAT_QUIZ_MODULES[`m${Math.min(activeModule.id, 7)}`]?.title}
                    </h4>
                    <p className="text-xs text-slate-400">
                      Reinforce derivations, indicator variables, Taylor expansion delta methods, and GNB decision boundaries.
                    </p>
                  </div>
                  <button
                    onClick={() => {
                    ...
                    className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white text-xs font-bold transition shadow-lg shadow-cyan-500/20 flex items-center gap-2 shrink-0"
                  >
          ...
          {activeTab === 'quiz' && (
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-900/90 border border-slate-800 rounded-2xl p-4 sm:p-5 shadow-md">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-slate-400">35 Rigorous Problems</span>
                  </div>
                  <h3 className="text-lg sm:text-xl font-bold text-white mt-1">
                    {showSolutionsGuide ? 'Comprehensive Statistics Solutions Guide' : 'Statistics Mastery Assessment & Derivations'}
                  </h3>
                </div>
                <div className="flex items-center gap-2.5">
                  <button
              ...
              {/* Module Selector Grid (Modules 1 to 7) */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-2.5">
                {[
                  { id: 'm1', label: 'Mod 1', title: 'Probability Space & RVs', sub: 'Sample Space, CDFs, Transformations' },
                  { id: 'm2', label: 'Mod 2', title: 'Distributions', sub: 'Binomial, Gaussian, Poisson, Exp' },
                  { id: 'm3', label: 'Mod 3', title: 'Expectation & Variance', sub: 'Covariance, Bilinear, Total Variance' },
                  { id: 'm4', label: 'Mod 4', title: 'Joint & Conditional', sub: 'Marginals, Bivariate Normal, Jacobians' },
                  { id: 'm5', label: 'Mod 5', title: 'CLT & Testing', sub: 'Delta Method, Z-Test, p-Values' },
                  { id: 'm6', label: 'Mod 6', title: 'MLE, MAP & Reg', sub: 'Gaussian MLE, Lasso L1 vs L2' },
                  { id: 'm7', label: 'Mod 7', title: 'Naive Bayes', sub: 'Bayes Rule, Laplace, GNB Boundaries' },
                ].map((m) => {
                  const isSelected = quizModuleKey === m.id;
                  const qMod = STAT_QUIZ_MODULES[m.id];
                  const answeredInMod = qMod.questions.filter((_, qIdx) => quizUserAnswers[`${m.id}_${qIdx}`] !== undefined).length;
                    ...
                    <button
                      ...
                      className={`border-2 p-3 rounded-xl text-left transition relative overflow-hidden group shadow-md flex flex-col justify-between ${
                        isSelected && !showSolutionsGuide
                          ? 'border-cyan-500 bg-slate-900 shadow-cyan-500/10 ring-1 ring-cyan-500/30'
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-1">
                          ...
                          {isCompleted ? (
                            ...
                            <span className="text-[9px] font-mono text-cyan-300 bg-cyan-950/60 px-1.5 py-0.2 rounded border border-cyan-800">
                              {answeredInMod}/{qMod.questions.length}
                            </span>
                          ) : null}
                        </div>
                        <h4 className="font-semibold text-slate-100 text-xs line-clamp-2 leading-tight">{m.title}</h4>
                      </div>
                ...
                <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 shadow-md relative space-y-6">
                  ...
                  <div>
                    <div className="flex items-center justify-between text-xs text-slate-400 mb-2 font-mono">
                      <span>
                        Question <strong className="text-white">{currentQuestionIdx + 1}</strong> of {currentQuizMod.questions.length}
                      </span>
                      <span className="text-cyan-400 font-semibold">{currentQuizMod.title}</span>
                    </div>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {currentQ.options.map((optText, idx) => {
                      ...
                      if (hasAnswered) {
                        if (isCorrect) {
                          btnStyle = "bg-emerald-950/60 border-emerald-500/80 text-emerald-200 font-medium shadow-sm shadow-emerald-500/10";
                        } else if (isSelected) {
                ...
                <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 shadow-md space-y-6">
                  <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                    <div>
                      ...
                      <p className="text-xs text-slate-400">
                        Complete step-by-step mathematical solutions for all 35 questions across Modules 1 through 7.
                      </p>
                    </div>
                    <button
                      onClick={() => setShowSolutionsGuide(false)}
                      className="px-4 py-2 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-white text-xs font-semibold transition flex items-center gap-1.5 shadow-md"
                    >
                  ...
                  <div className="space-y-6">
                    {Object.keys(STAT_QUIZ_MODULES).map((mKey) => {
                      const mod = STAT_QUIZ_MODULES[mKey];
                      return (
                        <div key={mKey} className="bg-slate-950/80 border border-slate-800/80 rounded-xl p-5 space-y-4">
                          <div className="flex items-center justify-between border-b border-slate-800 pb-2">
                            <h4 className="text-sm font-bold text-cyan-400 flex items-center gap-2">
                              <ChevronRight className="w-4 h-4 text-cyan-500" /> {mod.title}
                            </h4>
                            <button
                              onClick={() => {
                            ...
                            {mod.questions.map((q, idx) => (
                              <div key={q.id} className="space-y-2 text-xs border-b border-slate-900 pb-4 last:border-0">
                                <div className="font-semibold text-slate-200">
                                  <span className="text-cyan-400 mr-1.5 font-bold">Q{idx + 1}:</span>
      ...
      {/* ==================== POPUP MODAL: CS229 STATS VIP FLASHCARDS ==================== */}
      {showFlashcardsModal && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-50 flex items-center justify-center p-3 sm:p-5 overflow-y-auto">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-4xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden my-auto animate-fade-in">
            {/* Modal Header */}
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] text-slate-400 font-mono">34 Essential Formulas</span>
                  </div>
                    ...
                    <div className="my-5 space-y-3 text-center">
                      {!isCardFlipped ? (
                        ...
                        <div className="space-y-3 animate-fade-in">
                          ...
                          <div className="bg-slate-950 p-3 sm:p-4 rounded-xl border border-slate-800 text-slate-100 text-sm sm:text-base overflow-x-auto shadow-inner max-w-2xl mx-auto">
                            <FlashcardFormula tex={activeCard.backFormula} />
                          </div>
                          <p className="text-xs sm:text-sm text-slate-300 max-w-xl mx-auto leading-relaxed">
                            <MathText text={activeCard.backExplanation} />
