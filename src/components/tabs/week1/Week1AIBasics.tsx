  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-5">
        {/* Mobile Step & Extras Navigator (strictly lg:hidden) */}
        <div className="lg:hidden space-y-2.5">
          ...
          {/* Mobile Study Hub Extras in compact row */}
          <div className="flex items-center gap-2 overflow-x-auto no-scrollbar pb-0.5">
            ...
            >
              <CreditCard className="w-3.5 h-3.5 text-indigo-400" /> Flashcards
            </button>
            <button
              onClick={() => setShowQuiz(true)}
              className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-900/90 hover:bg-slate-800 border border-slate-800 rounded-xl transition text-xs text-slate-300 shrink-0 font-medium active:scale-95"
            >
              <Award className="w-3.5 h-3.5 text-amber-400" /> Final Test
            </button>
            <button
            ...
            >
              <NotebookPen className="w-3.5 h-3.5 text-amber-400" /> Notes
            </button>
          </div>
        </div>

        {/* Desktop Sidebar nav (hidden on mobile, lg:block on desktop) */}
        ...
        <div className="flex-1 min-w-0 space-y-4">
          ...
          <div className="rounded-2xl border border-slate-800 shadow-md overflow-hidden">
            ...
            <div className="px-4 sm:px-5 pt-4 sm:pt-5 pb-3 sm:pb-4 bg-gradient-to-br from-slate-900 via-slate-900 to-indigo-950/30 border-b border-slate-800 flex items-center gap-3">
            ...
            {/* Step body */}
            <div className="p-4 sm:p-5 bg-slate-950/30">
              {renderStep()}
            </div>
          </div>
        </div>
